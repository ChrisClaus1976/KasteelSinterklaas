<?php
	...
	<head>
		...
		<script type="text/javascript">	
			...
			function reservatie_tonen(reservatieid)
			{
				...
				xHTTP.open("GET", "ajax/onthaalreservatie1.php?reservatieid=" + reservatieid, true);
				xHTTP.send();
			}
	...
	if ($aantalrecords>0)
	{
		...
		while($row = mysqli_fetch_assoc($result))
		{
			...
			if ($Canceled!=1)
			{
				echo "<input type=\"button\" class=\"buttongroot\" onclick=\"reservatie_tonen('$ReservatieId')\" value=\"$Tijdstip - $Naam\" style=\"height: 50px; width: 300px;\"><br><br>";
			}
		}
		//echo "</table>";
	}
