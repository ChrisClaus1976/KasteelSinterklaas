	...
	<head>
		...
		<script type="text/javascript">			
			function toon_maand1()
			{
				...
				xhttp.open("GET", "ajax/toon_dagen_voorinschr.php?soort=wachtlijst" , true);
				xhttp.send();
			}
			...
			function toon_maand2()
			{
				...
				xhttp.open("GET", "ajax/toon_dagen_voorinschr.php?soort=contactlijst" , true);
				xhttp.send();
			}
					...
					xhttp.onreadystatechange = function() 
					{
						if (this.readyState == 4 && this.status == 200) 
						{
							...
							if (xhttp.responseText==0)
							{
								...
								location.href = 'voorinschrijving_leden.php';
							}
							else
							{
								if (xhttp.responseText==1)
								{
									location.href = 'reservatie_voorinschr.php';
								}
								else
								{
									document.getElementById("formmelding").innerHTML = xhttp.responseText;
