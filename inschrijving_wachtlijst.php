	...
	<head>
		...
		<script type="text/javascript">			
			function toon_maand1()
			{
				...
				xhttp.open("GET", "ajax/toon_dagen_wachtlijst.php?soort=wachtlijst" , true);
				xhttp.send();
			}
			...
			function toon_maand2()
			{
				...
				xhttp.open("GET", "ajax/toon_dagen_wachtlijst.php?soort=contactlijst" , true);
				xhttp.send();
			}
				...
				if(antw)
				{
					...
					xhttp.onreadystatechange = function() 
					{
						if (this.readyState == 4 && this.status == 200) 
						{
							...
							{
								alert("Het gekozen tijdslot is ondertussen door een ander gezin gereserveerd en is niet meer beschikbaar.");
								location.href = 'inschrijving_wachtlijst.php';
							}
							else
							{
								if (xhttp.responseText==1)
								{
									location.href = 'reservatie_wachtlijst.php';
								}
								else
								{
									document.getElementById("formmelding").innerHTML = xhttp.responseText;
						...
						<div class="col-md-8 px-0">
							<div class="detail-box">
								...
								<?php
									...
									echo "</li></ul></ul>
									<b>Locatie:</b> Kasteelstraat 2, 3670 Oudsbergen<br>";
									echo "";
