	...
	<head>
		...
		<script type="text/javascript">	
			...
			function TijdstipReserveren()
			{
				...
				document.getElementById('selVereniging').style.backgroundColor = '';
				...
				if(document.getElementById('selVereniging').value == '')
				{
					document.getElementById('selVereniging').style.backgroundColor = 'red';
					errors = true;
				}
				...
				else
				{
					if (document.getElementById("chkBetalingOK").checked)
					{
						...
						xhttp.onreadystatechange = function() 
						{
							if (this.readyState == 4 && this.status == 200) 
							{
								...
								{
									//alles OK
									alert("De reservatie is gelukt. Je ontvangt een mail op " + mail + " met de nodige info. Indien je geen mail ontvangen hebt, kijk eens bij de ongewenste/spam mails.");
					...
					else
					{
						...
						document.getElementById('formmelding').innerHTML = 'Je moet akkoord gaan met de betaling.';
					}
						...
						<div class="col-md-8 px-0">
							<div class="detail-box">
								<?php
									...
									echo "<table>";
									echo "<tr><td colspan=2><h5><b>Gegevens lid vereniging</b></h5></td></tr>";
									echo "<tr><td>Soort</td><td>";
									echo "<select id=\"selVereniging\"  onChange=\"sla_waarde_op('Vereniging', this.value);\">";
									echo "<option value=\"\" selected></option>";
									echo "<option value=\"Wachtlijst\" >Wachtlijst</option>";
									/*if ($Vereniging=='')
									{
										echo "<option value=\"\" selected></option>";
									}
									...
									if ($Vereniging=='LG')
									{
										echo "<option value=\"LG\" selected>Landelijke Gilde Gruitrode</option>";
									}
									else
									{
										echo "<option value=\"LG\" >Landelijke Gilde Gruitrode</option>";
									}
									if ($Vereniging=='Dorser')
									{
										echo "<option value=\"Dorser\" selected>Dorser</option>";
									}
									else
									{
									...
									if ($prijsvolwopm != '')
									{
										echo "Hiervoor krijgt u $prijsvolwopm.";
									}
									echo "</td></tr>";
